  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="py-24 px-6 text-center bg-gradient-to-b from-white via-blue-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        >
          I design and develop efficient, scalable web applications with clean UI/UX.
          I work across the stack using <strong>MERN & PERN</strong>, <strong>Next.js</strong>, and <strong>React</strong>,
          and I also build <strong>AI-powered solutions</strong> including <strong>RAG systems</strong>,
          <strong>autonomous agents</strong>, and <strong>AI automation</strong>.
          ...
          {[
            {
              ...
              desc: "Building complete web applications using MongoDB, Express, React, and Node.js.",
            },
            {
              icon: <Laptop className="w-10 h-10 text-blue-600" />,
              title: "Next.js & React",
              desc: "Modern frontends with reusable components, animations, and dark mode support.",
            },
            {
              icon: <Globe className="w-10 h-10 text-blue-600" />,
              title: "Responsive UI/UX",
              desc: "Designing user-centered interfaces that work seamlessly across all devices.",
            },
            {
              icon: <Code className="w-10 h-10 text-blue-600" />,
              title: "PERN Stack Development",
              desc: "Building scalable applications using PostgreSQL, Express, React, and Node.js.",
            },
            {
              icon: <Globe className="w-10 h-10 text-blue-600" />,
              title: "RAG Systems",
              desc: "Developing Retrieval-Augmented Generation systems for intelligent search and Q&A.",
            },
            {
              icon: <Laptop className="w-10 h-10 text-blue-600" />,
              title: "AI Agents & Automation",
              desc: "Creating autonomous AI agents and automating workflows to boost efficiency.",
            },
          ].map((item, i) => (
            <motion.div
              key={i}
      ...
      <section className="relative py-24 px-6 text-center overflow-hidden bg-gradient-to-b from-white via-blue-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        >
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition duration-300 cursor-pointer"
          >
